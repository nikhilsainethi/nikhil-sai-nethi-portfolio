...
export default function Home() {
  return (
    <main className="bg-transparent text-foreground">
            ...
            <section className="grid w-full items-center gap-6 lg:grid-cols-[minmax(15rem,0.6fr)_minmax(0,1.4fr)] lg:gap-12">
              ...
              <Reveal className="group order-2 flex justify-center lg:order-1 lg:justify-start" delay={1.2}>
                <TiltCard className="relative w-full max-w-[18rem] sm:max-w-[20rem]">
                  <div className="glass-panel shimmer-card relative w-full overflow-hidden rounded-[2rem] border border-border/70 bg-surface/70 p-4 shadow-[var(--shadow-card)]">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_color-mix(in_srgb,var(--surface-strong)_72%,transparent),transparent_60%)]" />
                    <div className="relative space-y-3">
                      <div className="overflow-hidden rounded-[1.55rem] border border-border/70 bg-surface-strong/70 p-1.5 shadow-[inset_0_1px_0_color-mix(in_srgb,var(--surface-strong)_78%,transparent)]">
                        <div className="relative overflow-hidden rounded-[1.4rem]">
                          <Image
                            alt="Nikhil Sai Nethi"
                            className="aspect-[4/5] h-auto w-full object-contain object-top bg-[radial-gradient(circle_at_top,_color-mix(in_srgb,var(--surface-strong)_82%,transparent),transparent_55%)] [clip-path:inset(0_0_0_0_round_1.4rem)] p-1 motion-safe:[animation:portrait-wipe_1.5s_cubic-bezier(0.16,1,0.3,1)_1.4s_both]"
                            height={960}
                            priority
                            ...
                            width={768}
                          />
                          <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-[color:color-mix(in_srgb,var(--foreground)_42%,transparent)] to-transparent" />
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-2">
                        {[
                          ...
                          <div key={label} className="rounded-[1rem] border border-border/70 bg-surface-strong/75 px-2.5 py-2.5 text-center shadow-[0_8px_20px_color-mix(in_srgb,var(--foreground)_10%,transparent)]">
                ...
                <div className="space-y-6">
                  <div className="inline-flex">
                    <div className="relative inline-flex rounded-full bg-gradient-to-r from-accent/50 via-purple-400/30 to-[#ff7820]/40 p-[1px] shadow-[0_0_28px_rgba(84,80,245,0.4)]">
                      <div className="inline-flex rounded-full border border-border/70 bg-surface-strong/80 px-5 py-2 backdrop-blur-md">
                  ...
                  <div className="space-y-4">
                    ...
                    <h1 className="text-5xl font-black tracking-[-0.04em] text-foreground sm:text-6xl lg:text-7xl xl:text-8xl">
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-2">
                      <p className="text-xl text-muted">Building</p>
                      <RoleCycler />
                      <p className="text-xl text-muted">systems.</p>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center gap-5 pt-4">
                    <MagneticButton>
                      <a
                        href="#experience"
                        className="inline-flex items-center gap-2 rounded-full bg-[var(--warm-accent)] px-7 py-3.5 text-sm font-bold text-white shadow-[0_0_30px_rgba(255,120,32,0.25)] transition-all hover:scale-105 hover:bg-[var(--warm-accent-strong)]"
                      >
                    ...
                    <MagneticButton>
                      <a
                        href={resumePath}
                        className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-surface-strong/75 px-7 py-3.5 text-sm font-bold text-foreground transition-all hover:bg-surface"
                      >
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <Reveal delay={0.1}>
              <div className="sticky top-24 space-y-6">
                ...
                <h2 className="text-3xl font-bold tracking-[-0.04em] text-foreground sm:text-5xl lg:text-6xl">
                  Code is easy.<br/>
            ...
            <div className="space-y-6">
              {engineeringLogs.map((log, i) => (
                <Reveal key={log.title} delay={0.1 + i * 0.1}>
                  <div className="card-hover glass-panel group rounded-[2rem] border border-border/70 bg-surface/65 p-6 shadow-[var(--shadow-card)] transition-all hover:border-accent/20 hover:bg-surface">
                    <div className="mb-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="font-mono text-xs text-muted">Engineering Log</p>
                      </div>
                      <FaArrowRight className="text-muted/60 transition-transform group-hover:translate-x-1 group-hover:text-foreground" />
                    </div>
                    <h3 className="text-xl font-bold text-foreground">{log.title}</h3>
                    <div className="mt-4 flex flex-wrap gap-2">
                      {log.tags.map(tag => (
                        <span key={tag} className="rounded-full border border-border/70 bg-surface-strong/75 px-3 py-1 text-xs text-muted">
                          {tag}
                        </span>
                      ))}
                    </div>
      ...
      <div className="my-10 border-y border-border/70 bg-surface/55 py-6">
      ...
      <StackedSection id="experience">
        <div className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="mx-auto w-full max-w-6xl">
            ...
            <div className="mb-10 flex items-end justify-between border-b border-border/70 pb-6">
              <div>
                <p className="mono-label text-[11px] text-[#ff7820]">03 · Experience</p>
                <h2 className="mt-2 text-4xl font-bold tracking-[-0.04em] text-foreground sm:text-5xl">
                  Work History
                </h2>
              </div>
              <Link
                href="/experience"
                className="hidden items-center gap-2 rounded-full border border-border/70 bg-surface-strong/75 px-5 py-2.5 text-sm font-bold text-foreground transition-all hover:bg-surface sm:flex"
              >
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {experiences.map((exp, i) => (
                <Reveal key={exp.company} delay={0.1 * i} className="h-full">
                  <div className={`card-hover glass-panel flex h-full flex-col rounded-[2rem] border p-6 shadow-[var(--shadow-card)] ${
                    exp.current ? "border-accent/45 bg-accent-soft" : "border-border/70 bg-surface/65"
                  }`}>
                    {exp.current && (
                    ...
                    <p className="mt-2 text-sm text-muted">{exp.period}</p>
                    <div className="mt-auto pt-6">
                      <div className="flex flex-wrap gap-2">
                        {exp.tags.map((t) => (
                          <span key={t} className="rounded-full border border-border/70 bg-surface-strong/75 px-2.5 py-1 text-[11px] font-medium text-muted">
                            {t}
                          </span>
                        ))}
                      </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              {skillGroups.map((group, i) => (
                <Reveal key={group.eyebrow} delay={i * 0.05}>
                  <div className="card-hover glass-panel h-full rounded-[1.6rem] border border-border/70 bg-surface/65 p-5 shadow-[var(--shadow-card)]">
                    <p className="mono-label mb-4 text-[10px] text-[#ffcc44]">{group.eyebrow}</p>
                    <div className="flex flex-wrap gap-2">
                      {group.items.map((item) => (
                        <span
                          key={item}
                          className="rounded-full border border-border/70 bg-surface-strong/75 px-3 py-1.5 text-xs text-muted transition-colors hover:border-accent/50 hover:bg-accent-soft hover:text-accent-strong"
                        >
                          {item}
                        </span>
                      ))}
        ...
        <div className="px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto w-full max-w-6xl text-center">
            ...
            <Reveal delay={0.1}>
              ...
              <h2 className="text-5xl font-black tracking-[-0.04em] text-foreground sm:text-7xl lg:text-8xl">
                Ready to scale?
              </h2>
              ...
              <div className="mt-12 flex flex-wrap justify-center gap-6">
                <MagneticButton>
                  <a
                    ...
                    className="inline-flex h-16 items-center gap-3 rounded-full bg-[var(--warm-accent)] px-8 text-lg font-bold text-white shadow-[0_0_36px_rgba(255,120,32,0.2)] transition-transform hover:scale-105 hover:bg-[var(--warm-accent-strong)]"
                  >
              ...
              <div className="mt-20 flex flex-wrap justify-center gap-4">
                {contactLinks.map(({ icon: Icon, label, href }) => (
                  <a
                    ...
                    className="group flex h-14 w-14 items-center justify-center rounded-full border border-border/70 bg-surface-strong/75 text-muted transition-all hover:border-accent/35 hover:bg-surface hover:text-foreground"
                    aria-label={label}
                  >
